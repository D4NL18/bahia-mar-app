            ...
            <ImageBackground style={styles.entirePage} source={background} resizeMode="stretch">
                <View style={{ flex: 10, justifyContent: "center", alignItems: "center" }}>
                    ...
                    <View style={{ justifyContent: 'space-evenly', alignItems: 'center', flex: 4 }}>
                        <Input label="Nova senha"></Input>
                        <Input label="Confirmar nova senha"></Input>
                        <Botao texto="Redefinir Senha" tipo="destaque" onPress={() => showModal()} />
                    </View>
                ...
                <Mod texto="Senha redefinida com sucesso" visible={visible} dismiss={hideModal} botao="Seguir" />
            </ImageBackground>
        </PaperProvider>
